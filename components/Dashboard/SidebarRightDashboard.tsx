      ...
      <div className="payments">
        <div className="payment">
          ...
          <div className="payment-details">
            ...
            <div>
              <span>
                La plataforma entrara en modo de mantenimiento el proximo 15 de
                noviembre del 2023 a las 17:00 horas
              </span>
        ...
        <div className="payment">
          ...
          <div className="payment-details">
            <h3>Clase</h3>
            <div>
              <span>Se suspende la clase del 19 de noviembre del 2023</span>
              <button className="icon-button class">
                <i className="ph-caret-right-bold"></i>
              </button>
            </div>
          </div>
